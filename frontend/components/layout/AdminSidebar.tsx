...
const items = [
  ...
  ["Approval queue", "/admin/pending-listings"],
  ["User management", "/admin/tenants"],
  ["Agent directory", "/admin/agents"],
  ...
  return (
    <aside className="fixed left-0 top-0 z-30 hidden h-full w-64 flex-col border-r border-stone-200 bg-[#efeeeb] p-5 md:flex">
      ...
      <div className="mt-8 rounded-lg border border-stone-200 bg-white p-4">
        ...
        <p className="mt-1 text-sm leading-6 text-stone-600">Moderation, approvals, reports and platform controls.</p>
      </div>
      ...
      <div className="mt-auto grid gap-3 border-t border-stone-200 pt-5">
        <Link className="rounded-lg bg-orange-600 px-4 py-3 text-center text-sm font-semibold text-white" href="/admin/pending-listings">
          Review queue
        </Link>
