        ...
        <header className="sticky top-0 z-20 border-b border-stone-200 bg-[#faf9f7]/95 px-4 py-4 backdrop-blur md:px-8">
          <div className="mx-auto flex max-w-7xl flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="mt-1 text-2xl font-semibold">Kodisha Control</h1>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <SearchControl className="w-full sm:w-80" placeholder="Search listings, agents or actions" />
              <Link className="rounded-lg bg-stone-950 px-4 py-3 text-center text-sm font-semibold text-white" href="/admin/audit">
                Audit log
              </Link>
            </div>
          </div>
